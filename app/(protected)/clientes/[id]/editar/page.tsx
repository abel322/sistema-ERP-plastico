    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          // Parámetros de Extrusión
          extTemperaturaAmbiente: data.extTemperaturaAmbiente?.toString() || '',
          extMotorPrincipal: data.extMotorPrincipal?.toString() || '',
          extTraccion: data.extTraccion?.toString() || '',
          extSopladorPrincipal: data.extSopladorPrincipal?.toString() || '',
          extAberturaBlower: data.extAberturaBlower?.toString() || '',
          extCuelloGlobo: data.extCuelloGlobo?.toString() || '',
          extTemperaturaCuelloGlobo: data.extTemperaturaCuelloGlobo?.toString() || '',
          extTraccionRebobinador: data.extTraccionRebobinador?.toString() || '',
          extRebobinadorWinding1: data.extRebobinadorWinding1?.toString() || '',
          extRebobinadorWinding2: data.extRebobinadorWinding2?.toString() || '',
          extIntensidadTratador: data.extIntensidadTratador?.toString() || '',
          extTemperaturaZ1: data.extTemperaturaZ1?.toString() || '',
          extTemperaturaZ2: data.extTemperaturaZ2?.toString() || '',
          extTemperaturaZ3: data.extTemperaturaZ3?.toString() || '',
          extTemperaturaZ4: data.extTemperaturaZ4?.toString() || '',
          extTemperaturaZ5: data.extTemperaturaZ5?.toString() || '',
          extTemperaturaZ6: data.extTemperaturaZ6?.toString() || '',
          extTemperaturaZ7: data.extTemperaturaZ7?.toString() || '',
          extTemperaturaZ8: data.extTemperaturaZ8?.toString() || '',
          extTemperaturaZ9: data.extTemperaturaZ9?.toString() || '',
          extTemperaturaZ10: data.extTemperaturaZ10?.toString() || '',
          extTemperaturaZ11: data.extTemperaturaZ11?.toString() || '',
          extTemperaturaZ12: data.extTemperaturaZ12?.toString() || '',
          extTemperaturaZ13: data.extTemperaturaZ13?.toString() || '',
          extTemperaturaZ14: data.extTemperaturaZ14?.toString() || '',
          extTemperaturaZ15: data.extTemperaturaZ15?.toString() || '',
          extTemperaturaZ16: data.extTemperaturaZ16?.toString() || '',
          extTemperaturaZ17: data.extTemperaturaZ17?.toString() || '',
          extTemperaturaZ18: data.extTemperaturaZ18?.toString() || '',
          extTemperaturaZ19: data.extTemperaturaZ19?.toString() || '',
          extTemperaturaZ20: data.extTemperaturaZ20?.toString() || '',
          extOrientacionFlujoBlower: data.extOrientacionFlujoBlower?.toString() || '',
        });
      }
    } catch (error) {
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <FormInput
                      label="Producto"
                      placeholder="Ej: Bolsa para café, Bobina industrial"
