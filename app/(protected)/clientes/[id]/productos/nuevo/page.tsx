              ...
              <div className="border-t pt-6">
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <h4 className="text-md font-bold text-blue-700 mb-3 flex items-center gap-2">
                    <span className="flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full text-xs">1</span>
                    Materia Prima 1
                  </h4>
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <h4 className="text-md font-bold text-blue-700 mb-3 flex items-center gap-2">
                    <span className="flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full text-xs">2</span>
                    Materia Prima 2
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                ...
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <h4 className="text-md font-bold text-blue-700 mb-3 flex items-center gap-2">
                    <span className="flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full text-xs">3</span>
                    Materia Prima 3
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
